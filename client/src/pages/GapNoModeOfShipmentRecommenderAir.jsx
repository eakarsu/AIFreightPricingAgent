...
// Auto-generated page for: No mode-of-shipment recommender (air vs LTL vs parcel)

export default function GapNoModeOfShipmentRecommenderAir() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-mode-of-shipment-recommender-air', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No mode-of-shipment recommender (air vs LTL vs parcel)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No mode-of-shipment recommender (air vs LTL vs parcel)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No mode-of-shipment recommender (air vs LTL vs parcel)'}
        </button>
      </form>
