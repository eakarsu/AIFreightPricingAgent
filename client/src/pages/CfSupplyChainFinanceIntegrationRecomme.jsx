...
// Auto-generated page for: Supply-chain finance integration recommending early-payment 

export default function CfSupplyChainFinanceIntegrationRecomme() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-supply-chain-finance-integration-recomme', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Supply-chain finance integration recommending early-payment </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Supply-chain finance integration recommending early-payment discounts vs float.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Supply-chain finance integration recommending early-payment '}
        </button>
      </form>
