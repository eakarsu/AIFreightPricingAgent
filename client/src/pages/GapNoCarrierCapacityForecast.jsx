...
// Auto-generated page for: No carrier-capacity-forecast

export default function GapNoCarrierCapacityForecast() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-carrier-capacity-forecast', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No carrier-capacity-forecast</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No carrier-capacity-forecast</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No carrier-capacity-forecast'}
        </button>
      </form>
