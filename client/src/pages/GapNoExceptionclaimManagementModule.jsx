...
// Auto-generated page for: No exception/claim management module

export default function GapNoExceptionclaimManagementModule() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-exceptionclaim-management-module', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No exception/claim management module</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No exception/claim management module</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No exception/claim management module'}
        </button>
      </form>
