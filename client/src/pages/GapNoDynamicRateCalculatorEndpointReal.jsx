...
// Auto-generated page for: No dynamic-rate-calculator endpoint (real-time LTL rates by 

export default function GapNoDynamicRateCalculatorEndpointReal() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-dynamic-rate-calculator-endpoint-real', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No dynamic-rate-calculator endpoint (real-time LTL rates by </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No dynamic-rate-calculator endpoint (real-time LTL rates by lane elasticity)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No dynamic-rate-calculator endpoint (real-time LTL rates by '}
        </button>
      </form>
