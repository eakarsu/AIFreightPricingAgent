...
// Auto-generated page for: Customer demand forecasting + lane capacity planning for adv

export default function CfCustomerDemandForecastingLaneCapacit() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-customer-demand-forecasting-lane-capacit', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Customer demand forecasting + lane capacity planning for adv</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Customer demand forecasting + lane capacity planning for advance bookings.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Customer demand forecasting + lane capacity planning for adv'}
        </button>
      </form>
