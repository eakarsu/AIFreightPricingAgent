...
export default function GapNoContractOptimizationRecommender() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-contract-optimization-recommender', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No contract-optimization recommender</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No contract-optimization recommender</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No contract-optimization recommender'}
        </button>
      </form>
