...
// Auto-generated page for: Carrier compliance + sustainability tracking with FMCSA safe

export default function CfCarrierComplianceSustainabilityTracki() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-carrier-compliance-sustainability-tracki', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Carrier compliance + sustainability tracking with FMCSA safe</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Carrier compliance + sustainability tracking with FMCSA safety ratings and carbon intensity.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Carrier compliance + sustainability tracking with FMCSA safe'}
        </button>
      </form>
