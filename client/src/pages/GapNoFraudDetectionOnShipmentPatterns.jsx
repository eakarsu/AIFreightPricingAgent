...
// Auto-generated page for: No fraud-detection on shipment patterns

export default function GapNoFraudDetectionOnShipmentPatterns() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-fraud-detection-on-shipment-patterns', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No fraud-detection on shipment patterns</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No fraud-detection on shipment patterns</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No fraud-detection on shipment patterns'}
        </button>
      </form>
