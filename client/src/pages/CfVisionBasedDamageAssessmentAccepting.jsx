...
// Auto-generated page for: Vision-based damage assessment accepting photos to estimate 

export default function CfVisionBasedDamageAssessmentAccepting() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-vision-based-damage-assessment-accepting', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Vision-based damage assessment accepting photos to estimate </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Vision-based damage assessment accepting photos to estimate repair cost and initiate claims.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Vision-based damage assessment accepting photos to estimate '}
        </button>
      </form>
