...
// Auto-generated page for: Multimodal optimization solver across truck/rail/ocean/air w

export default function CfMultimodalOptimizationSolverAcrossTr() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multimodal-optimization-solver-across-tr', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Multimodal optimization solver across truck/rail/ocean/air w</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Multimodal optimization solver across truck/rail/ocean/air with cost/service-level trade-offs.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Multimodal optimization solver across truck/rail/ocean/air w'}
        </button>
      </form>
